...
- Sponsored by Emory Hospital (confirmed by Akkhil, Sept 25, 2026). Card shows "In progress" plus a "Sponsor" label with the Emory University Hospital logo (`public/logos/`, from Wikimedia Commons, one-colour via CSS mask). `[?]` Lab or team, role, approach.
